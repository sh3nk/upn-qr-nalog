<?php
/*
 * This file includes parts of KrivArt QrCode.
 *
 * (c) Noah Too aka Krivah <krivahtoo@gmail.com>
 */

namespace QrCodeGenPhp;
...
class QrCode {
     ...
     * @param ECC   $errorCorrectionLevel The error correction level used in this QR Code.
     ...
     * @param ECC    $ecl  Error correction level
     *
     * @throws \Exception
     **/
